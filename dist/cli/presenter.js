...
exports.printHealth = printHealth;
exports.printRules = printRules;
exports.printDirJson = printDirJson;
function printReport(result, verbose = false, asJson = false) {
    ...
    for (const issue of sorted) {
        const icon = { critical: '[CRIT]', high: '[HIGH]', medium: '[MED]', low: '[LOW]' }[issue.severity];
...
function printRules(rules, total) {
...
function printDirJson(allResults) {
